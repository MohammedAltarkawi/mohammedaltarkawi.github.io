...
sap.ui.define([], function () {
  ...
  const config = {
    ...
    capabilities: [{
      ...
      browserName: "chrome",
      "goog:chromeOptions": {
        args: process.argv.indexOf("--headless") > -1 ? ["--headless"] : process.argv.indexOf("--debug") > -1 ? ["window-size=1440,800", "--auto-open-devtools-for-tabs"] : ["window-size=1440,800"]
      },
...
//# sourceMappingURL=wdio.conf-dbg.js.map
